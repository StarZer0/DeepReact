...
const enableIsInputPending = dynamicFeatureFlags.enableIsInputPending,
  ...
  try {
    if (enableProfiling) {
      try {
        ...
        if (currentTask !== null) {
          const currentTime = exports.unstable_now(); // $FlowFixMe[incompatible-call] found when upgrading Flow
...
const unstable_Profiling = enableProfiling
  ? {
