...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$265 = isSupported$jscomp$inline_428;
...
function clearRootResources(rootContainer) {
  rootContainer = rootContainer.getRootNode();
...
var SuspenseException = Error(formatProdErrorMessage(460)),
  thenableState = null;
function isThenableStateResolved(thenables) {
  thenables = thenables[thenables.length - 1];
  return void 0 !== thenables
    ? ((thenables = thenables.status),
      "fulfilled" === thenables || "rejected" === thenables)
    : !0;
}
function noop$1() {}
...
function renderWithHooks(
  ...
  thenableState = nextRenderLanes = workInProgressSuspendedThenableState;
  shouldDoubleInvokeUserFnsInHooksDEV = !1;
  ...
  if (didScheduleRenderPhaseUpdateDuringThisPass) {
    ...
    do {
      ...
      if (25 <= children) throw Error(formatProdErrorMessage(301));
      children += 1;
      workInProgressHook = currentHook = null;
      workInProgress.updateQueue = null;
      ReactCurrentDispatcher$1.current = HooksDispatcherOnRerender;
      thenableState = nextRenderLanes;
      var children$jscomp$0 = Component(props, secondArg);
    } while (didScheduleRenderPhaseUpdateDuringThisPass);
    children = children$jscomp$0;
  }
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$96 = thenableIndexCounter;
      thenableIndexCounter += 1;
      return trackUsedThenable(usable, index$96);
    }
    if (
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$102 = enqueueUpdate$1(provider, fiber, lane);
        null !== root$102 &&
          (scheduleUpdateOnFiber(root$102, provider, lane, eventTime),
          entangleTransitions(root$102, provider, lane));
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$98 = workInProgressRoot;
      if (null === root$98) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$98, renderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$98 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$98;
    mountEffect(subscribeToStore.bind(null, fiber, root$98, subscribe), [
      subscribe
    ]);
    fiber.flags |= 1024;
    pushEffect(
...
function updateDehydratedSuspenseComponent(
  ...
  if (didReceiveUpdate || digest) {
    ...
    nextProps = createCapturedValue(Error(formatProdErrorMessage(421)));
    return retrySuspenseComponentWithoutHydrating(
      current,
      workInProgress,
      renderLanes,
...
function prepareFreshStack(root, lanes) {
  ...
  workInProgressSuspendedReason = 0;
  workInProgressSuspendedThenableState = workInProgressThrownValue = null;
  workInProgressRootDidAttachPingListener = !1;
  workInProgressRootExitStatus = 0;
  workInProgressRootFatalError = null;
...
function handleThrow(root, thrownValue) {
  ...
  if (didScheduleRenderPhaseUpdate) {
    for (root = currentlyRenderingFiber$1.memoizedState; null !== root; ) {
      var queue = root.queue;
  ...
  if (thrownValue === SuspenseException) {
    ...
    root = thenableState;
    thenableState = null;
    workInProgressSuspendedThenableState = root;
    ...
    try {
      if (0 !== workInProgressSuspendedReason && null !== workInProgress)
        switch (
          ...
          case 2:
            if (
              null !== workInProgressSuspendedThenableState &&
              isThenableStateResolved(workInProgressSuspendedThenableState)
            )
              (workInProgressSuspendedReason = 0),
                (workInProgressThrownValue = null),
                replaySuspendedUnitOfWork(lanes, memoizedUpdaters);
            else {
              lanes = function() {
                ensureRootIsScheduled(root, now());
              };
              workInProgressThrownValue.then(lanes, lanes);
              break a;
            }
            break;
          case 3:
