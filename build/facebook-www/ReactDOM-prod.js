...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$244;
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$244 = isSupported$jscomp$inline_407;
  } else JSCompiler_inline_result$jscomp$244 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$244 &&
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      ...
      return trackUsedThenable(usable, index$93);
    }
    if (
        ...
        switch (workInProgressSuspendedReason) {
          ...
          case 2:
            if (
              ...
              (workInProgressSuspendedReason = 0),
                (workInProgressThrownValue = null),
                replaySuspendedUnitOfWork(lanes, thrownValue);
            else {
              lanes = function() {
                ensureRootIsScheduled(root, now());
              };
