...
(function(){(function (global, factory) {
    ...
    for (const propKey in nextProps) {
      ...
      if (propKey === STYLE) {
        ...
        if (typeof nextProp === 'string') {
          ...
          const canSetTextContent = ( tag !== 'body') && (tag !== 'textarea' || nextProp !== '');
  ...
  function updateHostResource(current, workInProgress, renderLanes) {
    ...
    workInProgress.memoizedState = getResource(workInProgress.type, workInProgress.pendingProps); // Resources never have reconciler managed children. It is possible for
        ...
        {
          {
            ...
            if (current !== null && workInProgress.stateNode != null) {
              ...
              if (wasHydrated) {
                ...
                workInProgress.stateNode = resolveSingletonInstance(type, newProps, rootContainerInstance);
                markUpdate(workInProgress);
              }
