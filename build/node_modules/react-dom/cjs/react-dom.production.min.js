...
const DidCapture = 0b00000000000000000001000000;
const Hydrating = 0b00000000000000100000000000;

const Update = 0b00000000000000000000000100;
const ChildDeletion = 0b00000000000000000000001000;
const ContentReset = 0b00000000000000000000010000;
const Callback = 0b00000000000000000000100000;
const ForceClientRender = 0b00000000000000000010000000;
const Ref = 0b00000000000000000100000000;
const Snapshot = 0b00000000000000001000000000;
const Passive = 0b00000000000000010000000000;
const Visibility = 0b00000000000001000000000000;
const StoreConsistency = 0b00000000000010000000000000;
const LifecycleEffectMask =
  Passive | Update | Callback | Ref | Snapshot | StoreConsistency;

const HostEffectMask = 0b00000000000011111111111111;

const Incomplete = 0b00000000000100000000000000;
const ShouldCapture = 0b00000000001000000000000000;
const ForceUpdateForLegacySuspense = 0b00000000010000000000000000;
const Forked = 0b00000010000000000000000000;

const RefStatic = 0b00000100000000000000000000;
const LayoutStatic = 0b00001000000000000000000000;
const PassiveStatic = 0b00010000000000000000000000;

const PlacementDEV = 0b00100000000000000000000000;
...
const contextStackCursor$1 = createCursor(emptyContextObject);
...
const NoFlags$1 = 0b0000;

const HasEffect = 0b0001;

const Insertion = 0b0010;
const Layout = 0b0100;
const Passive$1 = 0b1000;
    ...
    case SuspenseComponent: {
      ...
      if (nextDidTimeout !== prevDidTimeout) {
        if (nextDidTimeout) {
          ...
          if ((workInProgress.mode & ConcurrentMode) !== NoMode) {
            if (isBadSuspenseFallback(current)) {
              renderDidSuspendDelayIfPossible();
            } else {
              renderDidSuspend();
            }
...
function ensureRootIsScheduled(root, currentTime) {
  ...
  if (existingCallbackPriority === newCallbackPriority && !false) {
    return;
  }
...
function batchedUpdates$1(fn, a) {
  ...
  try {
    ...
    if (executionContext === NoContext && !false) {
      resetRenderTimer();
      flushSyncCallbacksOnlyInLegacyMode();
    }
  }
...
function shouldAttemptToSuspendUntilDataResolves() {
  ...
  if (includesOnlyTransitions(workInProgressRootRenderLanes)) {
    ...
    if (suspenseHandler !== null && suspenseHandler.tag === SuspenseComponent) {
      ...
      if (isBadSuspenseFallback(currentSuspenseHandler)) {
        return true;
      } else {
        return false;
      }
